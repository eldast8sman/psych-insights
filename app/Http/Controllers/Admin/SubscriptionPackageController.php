...
class SubscriptionPackageController extends Controller
{
    ...
    public function summary(){
        ...
        $free_trial = SubscriptionPackage::where('free_trial', 1)->first();
        $recent_subscribers = CurrentSubscription::where('subscription_package_id', '<>', $free_trial->id)->where('grace_end', '>=', date('Y-m-d'))->orderBy('updated_at', 'desc')->orderBy('grace_end', 'desc')->get();
